...
const Checkout = () => {
  ...
  <button onClick={orderHandler}  className="bg-indigo-500 font-semibold hover:bg-indigo-600 py-3 text-sm text-white uppercase w-full">FINALIZAR COMPRA</button>
  </>
  )
}
